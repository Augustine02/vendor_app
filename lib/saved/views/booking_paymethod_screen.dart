...
import 'package:vendor_app/saved/views/selectPaymentMethod.dart';
class BookingPaymethodScreen extends StatelessWidget {
  const BookingPaymethodScreen({Key? key}) : super(key: key);
